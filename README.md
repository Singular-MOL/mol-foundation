...
| Document | Type | DOI |
|----------|------|-----|
| MOL Whitepaper v1.0 | Working paper | [10.5281/zenodo.17445023](https://doi.org/10.5281/zenodo.17445023) |
| Philosophical Foundations | Publication | [10.5281/zenodo.17454907](https://doi.org/10.5281/zenodo.17454907) |
| Mathematical Formalization | Publication | [10.5281/zenodo.17464082](https://doi.org/10.5281/zenodo.17464082) |
| MOL Computational Formalization v3. | md | [https://github.com/Singular-MOL/mol-foundation](docs/MOL_Computational_Formalization_v3(English).md) |
...
- [🔬 Scientific Core v2](docs/MOL_Computational_Formalization_v2(English).md)
- [🧩 Principles Guide](metaprinciples/)

## 🛠 Tools and Implementation
- [FILM_INDUSTRY](research/films/mol_forecast_hail_mary_v1_202511_v6.2.py) - Systems analysis (film industry)
...
### 📋 Templates & Examples:
- **[Universal Template](community-evidence/templates/CONTRIBUTION_TEMPLATE.md)** - for all domains
